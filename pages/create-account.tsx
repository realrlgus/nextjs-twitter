    ...
    <div className="p-2 flex justify-center items-center min-h-screen md:bg-black md:bg-opacity-30">
      <div className="flex flex-col w-screen h-screen md:w-[28rem] md:h-[32rem] md:rounded-xl bg-white md:p-4">
        <div className="flex justify-between items-center">
          <div className="w-8 h-8 p-1 hover:bg-gray-200 rounded-full transition-color">
        ...
        >
          <span className="font-semibold text-2xl mb-2">계정 생성하기</span>
          <input
            type="text"
            autoComplete="off"
            className={cls(
          ...
          <span className="text-gray-500 text-sm ">
            이미 계정이 있으신가요?{" "}
            <Link href={`/log-in`}>
              <a className="text-blue-400">로그인하기</a>
            </Link>
          </span>
        </form>
      </div>
